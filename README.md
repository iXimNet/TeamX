# TeamX Project Management Tool

TeamX (Code: Zenith) is a lightweight, modern, and developer-focused project management tool designed for small, agile software teams. It aims to provide a fast, beautiful, and intuitive alternative to bloated or outdated platforms, focusing only on the core features that teams use every day.

## About The Project

This project was built to address the need for a simple yet powerful project management tool that prioritizes user experience and performance. The core vision for TeamX is to be:
